...
import java.awt.Point;
    ...
    public class program extends Frame{
         ...
         */
        private static Point starPoint=new Point(80,80);
        private static Point endPoint=new Point(1280,880);
        /**
         ...
         */
        public program(int length_of_side,int row_num,int column_num,int start_x,int start_y,int end_x,int end_y) {
            size=length_of_side;
...
//				System.out.println("jump");
        ...
        public static void main(String[] args) {
            ...
            new program(80,15, 10, 80, 80, 1280,880);
        }
    }
